...
import { Check, ShieldCheck, Zap, Crown, ArrowRight, Loader2, Sparkles, Building2 } from 'lucide-react';
      ...
      const res = await fetch(`${API_URL}/api/payments/create-checkout-session`, {
        ...
        body: JSON.stringify({
          booking: {
            ...
            email: bookingInfo?.email || 'customer@example.com',
